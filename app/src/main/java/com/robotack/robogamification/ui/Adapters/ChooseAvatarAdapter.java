...
public class ChooseAvatarAdapter extends RecyclerView.Adapter<ChooseAvatarAdapter.CustomViewHolder> {
    Activity mActivity;
    List<GenderModel.Datum> data;
    SelectGenderListener selectGenderListener;
    public ChooseAvatarAdapter(Activity activity, List<GenderModel.Datum> data, SelectGenderListener selectGenderListener) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_choose_avatar, parent, false);
    ...
    public void onBindViewHolder(final CustomViewHolder holder, final int position) {
        ...
        try {
            Glide.with(mActivity).load(data.get(position).getImage()).into(holder.avatarImage);
        } catch (Exception e) {
